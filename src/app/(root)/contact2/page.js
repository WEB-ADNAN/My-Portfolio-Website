...
const Contact = () => {
  return (
    <>
        <section className='bg-[#080b11] border-t border-[rgba(212,175,55,0.5)] pt-32 md:pt-32 md:pb-30 pb-20'>
            <div className="container px-4 lg:px-3 xl:px-2 2xl:px-0">
                ...
                <div className="lg:flex lg:flex-row flex flex-col gap-8 lg:gap-0 pt-20 justify-around">
                    ...
                    <div className="flex flex-col justify-center items-center lg:items-start lg:justify-start lg:w-[50%] xl:w-[60%]">
                    ...
                    <div className="flex lg:flex-col justify-center xl:justify-start lg:w-[50%] xl:w-[40%]">
