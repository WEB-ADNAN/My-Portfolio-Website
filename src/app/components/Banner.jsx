            ...
            <div className="container  md:flex-row md:flex md:text-left items-center px-4 md:px-0 gap-15 md:gap-0">
                <div className="w-full text-center md:text-left md:w-[70%]">
                    ...
                    <div className="">
                        ...
                        <div className="icons flex justify-center md:justify-start gap-2.5 items-center pt-4">
                        ...
                        <p className={`${dmSans.className} text-[20px] text-[#9A9A9A] pt-4 md:pr-32.5 px-4 md:px-0`}>I craft fast, scalable web applications with clean code and pixel-perfect precision delivering intuitive interfaces, powerful backends, and seamless experiences that make an impact. Available for job and freelance projects.</p>

                        <div className="pt-5">
                            <div className="icon flex justify-center md:justify-start gap-4 text-[25px] items-center">
                        ...
                        <div className="banner-button flex justify-center md:justify-start gap-6 pt-10 md:pt-10 pb-10 md:pb-20">
                            <div className="B1">
                        ...
                        <div className="working flex justify-center md:justify-start">
