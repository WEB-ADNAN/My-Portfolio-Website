                  ...
                  <Tabs>
                    <TabList>
                      <div className="flex gap-6 justify-center ">
                        <Tab>
                          <button className={`text-[#C6C6C6] bg-[rgba(255,255,255,0.08)] text-[16px] ${cormorant.className} font-bold leading-[160%] px-10 py-3.5 rounded-lg `}>ALL</button> 
                        </Tab>
                        <Tab>
                          <button className={`text-[#C6C6C6] bg-[rgba(255,255,255,0.08)] text-[16px] ${cormorant.className} font-bold leading-[160%] px-10 py-3.5 rounded-lg `}>React</button>
                        </Tab>
                      </div>
                    </TabList>
